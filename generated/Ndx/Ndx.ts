...
export class Ndx__checkpointsResult {
  value0: BigInt;
  value1: BigInt;
...
export class Ndx extends ethereum.SmartContract {
  static bind(address: Address): Ndx {
    return new Ndx("Ndx", address);
  }
  ...
  checkpoints(param0: Address, param1: BigInt): Ndx__checkpointsResult {
    let result = super.call(
      "checkpoints",
    ...
    return new Ndx__checkpointsResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_checkpoints(
    param0: Address,
    param1: BigInt
  ): ethereum.CallResult<Ndx__checkpointsResult> {
    let result = super.tryCall(
      "checkpoints",
      "checkpoints(address,uint32):(uint32,uint96)",
      [
    ...
    return ethereum.CallResult.fromValue(
      new Ndx__checkpointsResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
